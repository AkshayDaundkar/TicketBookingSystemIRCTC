...
public class TrainService {
    ...
    private boolean validTrain(Train train, String source, String destination) {
        ...
        int sourceIndex = stationOrder.indexOf(source.toLowerCase().trim());
        int destinationIndex = stationOrder.indexOf(destination.toLowerCase().trim());

        System.out.println("DEBUG: Checking train " + train.getTrainId() +
                " | Source Index: " + sourceIndex + " | Destination Index: " + destinationIndex);
